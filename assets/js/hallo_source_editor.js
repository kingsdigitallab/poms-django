...
dy-body"></div></div>\n        </div><!-- /.modal-content -->\n    </div><!-- /.modal-dialog -->\n</div>');
                    ...
                    modalBody.html('<textarea placeholder="Anchor name..." style="height: 400px; width: 92%; font: 14px/21px monospace; border: 1px solid #d8d8d8; background: #f4f4f4; margin: 2% 4%;" id="wagtail-edit-html-content">'+widget.options.editable.element.html()+'</textarea><button i\
