...
urlpatterns = [
    ...
    # a customized view for the application admin home
    url(r'^' + prefix + 'admin/(pomsapp/)$', poms_custom_admin_views.pomsapp),
    url(r'^' + prefix + 'admin/created_possplaces/$', poms_custom_admin_views.created_possplaces, name='created_possplaces'),
    url(r'^' + prefix + 'admin/missing_possplaces/$', poms_custom_admin_views.missing_possplaces, name='missing_possplaces'),
    url(r'^' + prefix + 'admin/created_docplaces/$', poms_custom_admin_views.created_docplaces, name='created_docplaces'),
    url(r'^' + prefix + 'admin/missing_docplaces/$', poms_custom_admin_views.missing_docplaces, name='missing_docplaces'),
    url(r'^' + prefix + 'admin/unmarked_factoids/$', poms_custom_admin_views.unmarked_factoids, name='unmarked_factoids'),
    url(r'^' + prefix + 'admin/orphan_titles/$', poms_custom_admin_views.orphan_titles, name='orphan_titles'),
    url(r'^' + prefix + 'admin/orphan_places/$', poms_custom_admin_views.orphan_places, name='orphan_places'),
    url(r'^' + prefix + 'admin/orphan_people/$', poms_custom_admin_views.orphan_people, name='orphan_people'),
    url(r'^' + prefix + 'admin/orphan_possessions/$', poms_custom_admin_views.orphan_possessions, name='orphan_possessions'),
    url(r'^' + prefix + 'admin/charterscirca/$', poms_custom_admin_views.charterscirca, name='charters_circa'),
    url(r'^' + prefix + 'admin/previous_landholder/$', poms_custom_admin_views.previous_landholder, name='previous_landholders'),
    url(r'^' + prefix + 'admin/contributions/$', poms_custom_admin_views.contributions, name='contributions'),
