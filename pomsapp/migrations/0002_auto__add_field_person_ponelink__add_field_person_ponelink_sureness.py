...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.ponelink'
        db.add_column('pomsapp_person', 'ponelink',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Person.ponelink_sureness'
        db.add_column('pomsapp_person', 'ponelink_sureness',
                      self.gf('django.db.models.fields.CharField')(default='pro', max_length=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.ponelink'
        db.delete_column('pomsapp_person', 'ponelink')

        # Deleting field 'Person.ponelink_sureness'
        db.delete_column('pomsapp_person', 'ponelink_sureness')
