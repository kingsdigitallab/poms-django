...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pomsapp_placetype', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_placetype', null=True, to=orm['auth.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='updated_placetype', null=True, to=orm['auth.User'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('pomsapp', ['PlaceType'])

        # Adding M2M table for field place_types on 'Place'
        m2m_table_name = db.shorten_name('pomsapp_place_place_types')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('place', models.ForeignKey(orm['pomsapp.place'], null=False)),
            ('placetype', models.ForeignKey(orm['pomsapp.placetype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['place_id', 'placetype_id'])

        # Adding field 'Person.has_family'
        db.add_column('pomsapp_person', 'has_family',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.has_grantor'
        db.add_column('pomsapp_person', 'has_grantor',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('pomsapp_placetype')

        # Removing M2M table for field place_types on 'Place'
        db.delete_table(db.shorten_name('pomsapp_place_place_types'))

        # Deleting field 'Person.has_family'
        db.delete_column('pomsapp_person', 'has_family')

        # Deleting field 'Person.has_grantor'
        db.delete_column('pomsapp_person', 'has_grantor')
    ...
    models = {
        ...
        'pomsapp.person': {
            ...
            'has_family': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'has_grantor': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'pomsapp.place': {
            ...
            'place_types': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['pomsapp.PlaceType']", 'null': 'True', 'blank': 'True'}),
            'review': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'pomsapp.placetype': {
            ...
            'created_at': ('utils.modelextra.myfields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_placetype'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'review': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'updated_at': ('utils.modelextra.myfields.ModificationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'updated_placetype'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'pomsapp.poss_alms': {
