...
class Factoid(mymodels.PomsModel):
    ...
    # 2010-11-17: new helper table to facilitate querying places from factoidsfrom django.utils.translation import ugettext_lazy as _
    # from django.conf.urls import *  # for the ajax autocomplete
    # from django.contrib.gis.db.models import *
    # from django.utils.translation import ugettext_lazy as _
    # # from settings import print
    ...
    # class Person(mymodels.PomsModel):
    #     persondisplayname = models.CharField(
    #         max_length=255, null=True, blank=True, verbose_name="Surface
    # name", )
    #     standardmedievalname = models.CharField(
    #         max_length=255, null=True, blank=True, verbose_name="Medieval
    # gaelic name", )
    #     moderngaelicname = models.CharField(
    #         max_length=255, null=True, blank=True, verbose_name="Modern
    # gaelic name", )
    #     persondescription = models.TextField(
    #         null=True, blank=True, verbose_name="biography", )
    #
    ...
    # verbose_name="post-modifier", )
    #     florlowkey = models.ForeignKey(
    #         'Floruit', null=True, blank=True, verbose_name="FROM  ::
    # century", related_name='flor_lowKey', )
    #     florhikey = models.ForeignKey(
    #         'Floruit', null=True, blank=True, verbose_name="TO  ::
    # century", related_name='flor_hiKey', )
    #
    #     genderkey = models.ForeignKey(
    #         'Gender', null=True, blank=True, verbose_name="Gender",
    # default=3)
    #
    #     forename = models.CharField(
    #         max_length=765, verbose_name="Forename", null=True, blank=True, )
    ...
    #     searchsurname = models.CharField(
    #         max_length=765,
    #         verbose_name="Normalized field including surnames stripped of
    # non-interesting particles, for searching "
    #                      "purposes only",
    #         null=True,
    #         blank=True, )
    #     # mikele: 18/1/10
    ...
    #     medievalgaelicsurname = models.CharField(
    #         blank=True, max_length=100, verbose_name="medieval gaelic
    # surname")
    #
    #     relatedplace = models.ForeignKey(
    #         'Place',
    #         null=True,
    #         blank=True,
    #         verbose_name="Related place [reference extracted from
    # place-institutional]",
    #         help_text="Experimental Feature: this value has been extracted
    #  from the place/institutional field below")
    #
    #     # 2010-11-17: new helper table to facilitate querying places'
    # hierarchies
    #     # from person (for FB specifically)
    #     helper_places = models.ManyToManyField(
    #         'Place',
    #         verbose_name="helper M2M table used to speed up searched in
    # FB, from all persons to all places",
    #         related_name='helper_persons')
    #
    #     # new 17/6/2010 :: default=True doesn't seem to work... well who
    # cares!
    #     helper_floruits = models.BooleanField(
    #         default=True, verbose_name="Calculate floruits automatically (
    # warning: saving time can take longer)",
    #         help_text="Using all primary transactions where person has
    # role: Grantor, Beneficiary, Addressor, Addressee, "
    #                   "Party 1, Party 2, Party 3, Consentor, Dated by hand
    #  of, Inspector, Scribe, Sealer, Signatory, "
    #                   "Witness")
    #     helper_merge = models.BooleanField(
    #         default=False, verbose_name="Keep as main record in \'merge\'
    # operation",
    #         help_text="Tick to indicate that other person-records will
    # have to be merged into this record, "
    #                   "and not otherwise")
    #     # mikele: 29June2010
    #     helper_bigsurname = models.CharField(
    #         max_length=765,
    #         verbose_name="Field that displays a combination surname,
    # sonOf, Patronym, ofString, Place-inst, for the FB "
    #                      "only",
    #         null=True, blank=True, )
    #     helper_searchbigsur = models.CharField(
    #         max_length=765, verbose_name="Same as field above,
    # but normalized", null=True, blank=True, )
    #
    #     helper_keywordsearch = models.CharField(
    ...
    #     helper_totfactoids = models.IntegerField(
    #         blank=True, null=True,
    #         verbose_name="Field that speeds up searches of people by tot
    # number of factoids associated to them. MIND that "
    #                      "it's not updated automatically, you need to
    # manually run fixture 8 instead!", )
    #
    #     helper_daterange = models.CharField(
    #         blank=True, null=True, max_length=100,
    #         verbose_name="helper field for date ranges - automatically
    # generated so to accommodate a fixed date-range "
    ...
    #
    #     def how_many_sources(self):
    #         """helper method: shows how many unique sources mention a
    # person"""
    #         l = []
    #         for x in self.getassocfactoids():
    #             try:
    ...
    #
    #     def nice_floruits(self):
    #         """Mind that we're using the html representation of the 'x'
    # sign """
    #
    #         if self.floruitstartyr and self.floruitendyr:
    #             return "%s &times; %s" % (self.floruitstartyr,
    # self.floruitendyr)
    #         elif self.floruitstartyr and not self.floruitendyr:
    #             return "%s &times;" % (self.floruitstartyr)
    #         elif not self.floruitstartyr and self.floruitendyr:
    ...
    #             # return ALL  [this supersedes what used to be called
    #             # get_all_associations]
    #             return list(self.getassocfactoids()) + list(
    # self.getassocfactoidproanimas()) + list(
    #                 self.assocfactoidwitness())
    #
    ...
    #                 return self.getassocfactoidproanimas()
    #             else:
    #                 return self.getassocfactoidproanimas().order_by(
    # *ordering)
    #
    #         elif whattype == "witness":
    #             if not ordering:
    ...
    #                 return self.assocfactoidwitness().order_by(*ordering)
    #         else:
    #             print("Valid factoid types are: 'possession',
    # 'relationship',"
    #                   "'title/occupation', 'transaction', 'proanima',
    # 'witness'"
    #                  )
    #             return []
    #
    ...
    #         Valid types are possession, relationship, title/occupation,
    # transaction ; or proanima and witness
    #         Returs the right subclass of Factoids, depending on what
    # requested.
    #         """
    #         if not whattype:
    #             return list(self.factoids.all()) + list(
    # self.factoidsproanima.all()) + list(self.factoidswitness.all())
    #         elif whattype in ['possession', 'relationship',
    # 'title/occupation', 'transaction']:
    #             if not ordering:
    #                 factoid_set = self.factoids.filter(
    # inferred_type=whattype)
    #             else:
    #                 factoid_set = self.factoids.filter(
    #                     inferred_type=whattype).order_by(*ordering)
    #             # returns the right factoid type
    #             return [f.get_right_subclass()[1] for f in factoid_set if
    # f.get_right_subclass]
    #
    #         elif whattype == "proanima":
    #             if not ordering:
    #                 return self.factoidsproanima.all()
    ...
    #                 factoid_set = self.factoidswitness.all()
    #             else:
    #                 factoid_set = self.factoidswitness.all().order_by(
    # *ordering)
    #             return [f.get_right_subclass()[1] for f in factoid_set if
    # f.get_right_subclass]
    #
    ...
    #             # return ALL  [this supersedes also get_all_associations]
    #             print
    #             "Valid factoid types are: 'possession', 'relationship',
    # 'title/occupation', 'transaction', 'proanima', " \
    #                 "'witness'"
    #             return []
    #
    ...
    #                 assochelperperson__person__id=p2.id).distinct()
    #             if common:
    #                 return [f.get_right_subclass()[1] for f in common if
    # f.get_right_subclass]
    #             else:
    #                 return []
    #
    ...
    #         >>> f1 =factoids[0]
    #         >>> f1
    #         <FactTransaction: id[42197], from source [4/32/24  (_Dunf.
    # Reg._, no. 211)] >
    #         >>> p1.get_factoidRole(f1)
    #         [<Role: Sealer>]
    #         >>> p2.get_factoidRole(f1)
    ...
    #     def get_admin_url(self):
    #         from django.core import urlresolvers
    #         return urlresolvers.reverse('admin:pomsapp_person_change',
    # args=(self.id,))
    #         # return "/%sadmin/pomsapp/person/%s" % (
    # django_settings.URL_PREFIX,
    #         # self.id)
    #
    #     get_admin_url.allow_tags = True
    #
    ...
    #             if len(main_persons) == 1:
    #                 feedback = merge_persons_inner(main_persons[
    #                     0], persons_to_merge)  # feedback= [main_person,
    # [merged_persons]]
    ...
    #
    #         list_display = ('id', 'persondisplayname', 'forename',
    #                         'surname', 'editedrecord', 'review',
    # 'updated_at',)
    #         # list_editable = ('persondisplayname',)
    #         # filter_horizontal = ('location',)
    #         # radio_fields = {"ltbrole": admin.VERTICAL}
    #         list_filter = ['created_at', 'updated_at',
    #                        'created_by__username', 'editedrecord',
    # 'review', ]
    #         search_fields = ['persondisplayname', 'id']
    #         date_hierarchy = 'created_at'
    #         fieldsets = [
    #             ('Administration',
    #              {'fields':
    #               ['helper_merge', 'editedrecord', 'review',
    ...
    # class Institution_Manager(models.Manager):
    #     def get_query_set(self):
    #         return super(Institution_Manager, self).get_query_set(
    # ).filter(genderkey__id=5)
    #
    #
    # class Institution(Person):
    #     objects = Institution_Manager()
    ...
    #     # new dates 15/1/10
    #     firmdate = models.CharField(
    #         max_length=765, null=True, blank=True, verbose_name="Firm date
    #  [preview]",
    ...
    #         default=False, verbose_name="DAY only firmdate")
    #     undated = models.BooleanField(default=False, verbose_name="undated")
    #     eitheror = models.BooleanField(default=False,
    # verbose_name="either/or")
    #     from_modifier = models.CharField(
    #         blank=True, max_length=3, choices=DATE_MODIFIERS,
    #         verbose_name="date of charter  - FROM", help_text="modifier")
    #  exa
    #     from_weekday = models.IntegerField(
    #         blank=True, null=True, choices=WEEKDAY_CHOICES, verbose_name="",
    #         help_text="weekday")
    ...
    # help_text="month")
    #     from_season = models.IntegerField(
    #         blank=True, null=True, choices=SEASON_CHOICES,
    # help_text="season", verbose_name="", )
    #     from_year = models.IntegerField(
    #         blank=True, null=True, verbose_name="", help_text="enter a
    # year in numbers")
    #     to_modifier = models.CharField(
    #         blank=True, max_length=3, choices=DATE_MODIFIERS,
    #         verbose_name="date of charter  - TO", help_text="modifier")
    #     to_weekday = models.IntegerField(
    #         blank=True, null=True, choices=WEEKDAY_CHOICES,
    # help_text="weekday", verbose_name="", )
    #     to_day = models.IntegerField(
    ...
    #     # end ======== new dates 15/1/10
    #     probabledate = models.CharField(
    #         max_length=765, null=True, blank=True, verbose_name="prob
    # date", )
    #     datingnotes = models.TextField(
    #         null=True, blank=True, verbose_name="dating notes", )
    #
    ...
    #     # 2010-08-18 => new inferred grantor category
    #     grantor_category = models.ForeignKey(
    #         GrantorCategory, null=True, blank=True, verbose_name="grantor
    # category")
    #
    #     helper_hammond = models.CharField(
    #         max_length=50, verbose_name="We store here the results of
    # get_hammondnumber(), for faster ordering", null=True,
    #         blank=True, )
    #     helper_keywordsearch = models.TextField(
    #         verbose_name="Field for the keyword search", null=True,
    # blank=True, )
    #     helper_daterange = models.CharField(
    #         blank=True, null=True, max_length=100,
    #         verbose_name="helper field for date ranges - automatically
    ...
    #                      "that it's not updated automatically, you need to
    #  manually run fixture 8 instead!", )
    #
    #     def get_right_subclass(self):
    #         # once you get a source instance, it's useful to know quickly
    # what
    #         # subclass it is...
    #         try:
    #             sbcls = ["charter", self.charter]
    ...
    # self.hammondext, self.source_tradid)
    #         return out
    #
    #     def __unicode__(self):
    #         return self.__str__()
    ...
    # class Charter(Source):
    #     chartertypekey = models.ForeignKey(
    #         'Chartertype', blank=True, null=True, verbose_name="document
    # type")
    #
    #     ischirograph = models.BooleanField(
    #         default=False, verbose_name="Chirograph?")
    #     doctypenotes = models.TextField(blank=True, verbose_name="Doc type
    #  notes")
    #     placedatemodern = models.CharField(
    #         max_length=765, null=True, blank=True, verbose_name="Place (
    # modern)", )
    #     placedatedoc = models.CharField(
    #         max_length=765, null=True, blank=True, verbose_name="Place (
    # document)", )
    ...
    #         default=False, verbose_name="Original (non-contemporary)")
    #     duporignoncontemp = models.BooleanField(
    #         default=False, verbose_name="Duplicate Original (
    # non-contemporary)")
    #
    #     helper_hnumber = models.CharField(
    #         max_length=100, null=True, blank=True, verbose_name="h-number",
    #         help_text="A helper field that conflates al the hNumbers,
    # for better alpha searching", )
    #     helper_copydates = models.BooleanField(
    #         default=True,
    #         verbose_name="Copy dates to related Factoids?",
    #         help_text="(excluding non-primary transactions)")
    #
    #     helper_tickboxes = models.ManyToManyField(
    #         'DocTickboxes', blank=True, verbose_name="normalization of
    # tickboxes",
    #         help_text="Helper field used for the faceted search - see
    # actionsmodels", )
    #
    #     def get_admin_url(self):
    #         from django.core import urlresolvers
    #         return urlresolvers.reverse('admin:pomsapp_charter_change',
    # args=(self.id,))
    #         # return "/%sadmin/pomsapp/charter/%s" %
    #         # (django_settings.URL_PREFIX_EXTRA, self.id)
    #
    ...
    #             handle_tickboxes(self)
    #             temp = self.get_hammondnumber()
    #             # initially we stored it only in Charter, now in Source
    # too to make searches in FB faster. Eventually we
    #             # could eliminate it from Charter object entyirely,
    # making sure all
    #             # code is updated as needed!
    #             self.helper_hnumber = temp
    #             self.helper_hammond = temp
    ...
    #             if self.helper_copydates:
    #                 copy_charter_dates2factoids(self)
    #             if not self.grantor_category:  # 2010-08-18  to enforce
    # it: ...... if True:
    #                 assign_grantorCategory(self)
    #             self = create_helperKeywordsearch(self)
    #             self = create_helperDateRange(self)
    ...
    #                        'editedrecord', 'review', 'undated',
    # 'has_firmdate']
    #         search_fields = ['source_tradid', 'placedatemodern',
    #                          'hammondnumber', 'hammondnumb2',
    # 'hammondnumb3', 'hammondext', 'id']
    #         fieldsets = [
    #             ('Administration',
    #              {'fields':
    ...
    #             ('Dates',
    #              {'fields':
    #               [('has_firmdate', 'has_firmdayonly', 'undated',
    # 'eitheror'),
    #                ('from_modifier', 'from_weekday', 'from_day',
    ...
    # class Matrix(Source):
    #     shape = models.ForeignKey(
    #         'MatrixShape', null=True, blank=True, verbose_name="matrix
    # shape", )
    #     owner = models.ForeignKey(
    #         'Person', null=True, blank=True, verbose_name="Owner", )
    ...
    #     image_desc = models.TextField(
    #         blank=True, null=True, verbose_name="image description (
    # obverse)")
    #     image_desc_rev = models.TextField(
    #         blank=True, null=True, verbose_name="image description (
    # reverse)")
    ...
    #     def get_admin_url(self):
    #         from django.core import urlresolvers
    #         return urlresolvers.reverse('admin:pomsapp_matrix_change',
    # args=(self.id,))
    #         # return "/%sadmin/pomsapp/matrix/%s" %
    #         # (django_settings.URL_PREFIX_EXTRA, self.id)
    #
    ...
    # type (not surviving)", blank=True, null=True,)
    #     # twosided = models.BooleanField(default=False, verbose_name="two
    # sided?")
    #     countersealed = models.BooleanField(
    #         default=False, verbose_name="countersealed?")
    #     archive = models.CharField(
    #         max_length=200, verbose_name="archive", blank=True, null=True, )
    #     archiverefnumber = models.CharField(
    #         max_length=100, verbose_name="archive ref number", blank=True,
    #  null=True, )
    #     conditionnote = models.TextField(
    #         verbose_name="condition note", blank=True, null=True, )
    #
    ...
    #     def get_admin_url(self):
    #         from django.core import urlresolvers
    #         return urlresolvers.reverse('admin:pomsapp_seal_change',
    # args=(self.id,))
    #         # return "/%sadmin/pomsapp/seal/%s" %
    #         # (django_settings.URL_PREFIX_EXTRA, self.id)
    #
    ...
    # 'updated_at',)
    #         search_fields = ('id',)
    #         list_filter = ('matrix_field', 'color', 'created_at',
    # 'updated_at',
    #                        'created_by__username', 'editedrecord', 'review',)
    #         fieldsets = [
    #             ('Administration',
    ...
    #     # HACK: I'm using the admin ForeignKeyRawIdWidget which needs a 'rel'
    #     # instance to be passed to it. I thus create this directly using the
    #     # ManyToOneRel class and a model/model_field combination. The
    # resulting
    #     # title object (selected by the user) is then extracted directly
    # from the
    #     # request object in the TransactionFactoid code (as it used to be)
    #     # todo ehall rawid widget broken by upgrade, this may not work
    #     title = forms.ModelChoiceField(
    ...
    # empty_label="(Nothing)",
    #         label="title [warning: creates a new title-factoid]",
    #         widget=widgets.ForeignKeyRawIdWidget(ManyToOneRel(TitleType,
    # 'id','id'),site))
    #     bygraceofgod = forms.BooleanField(required=False, label="by grace
    # of..")
    #     byanotherdivineinvocation = forms.BooleanField(
    #         required=False, label="by another divine..")
    #
    ...
    #     verbose_name = 'Associated person'
    #     verbose_name_plural = 'Associated people'
    #     extra = 4  # 2011-07-26: note that this seems to be overridden by
    # the one in models.py
    #     related_search_fields = {
    #         'person': ('persondisplayname',),
    #         'role': ('name',),
    #     }
    ...
    # class Factoid(mymodels.PomsModel):
    #     inferred_type = models.CharField(
    #         max_length=100, null=True, blank=True, verbose_name="inferred
    # type", )
    #     sourcekey = models.ForeignKey('Source', verbose_name="Document",
    #                                   related_name='factoids')
    #     people = models.ManyToManyField(
    ...
    #     # I put them here even though they're used only by specific Factoids!
    #     witnesses = models.ManyToManyField(
    #         Person, through='AssocFactoidWitness',
    # related_name='factoidswitness',
    #         verbose_name="witnesses", )
    #     proanimapeople = models.ManyToManyField(
    #         Person, through=AssocFactoidProanima,
    # related_name='factoidsproanima',
    #         verbose_name="pro anima people", )
    #
    #     # 2010-11-17: new helper table to facilitate querying places from
    # factoids
    #     # and sources (for FB specifically)
    #     helper_places = models.ManyToManyField(
    #         'Place',
    #         verbose_name="helper M2M table used to speed up searched in
    # FB, from all factoids to all places (bypassing "
    #                      "the possessions)",
    #         related_name="helper_factoids")
    #     poss_alms = models.ManyToManyField(
    #         Poss_Alms, through='AssocFactoidPoss_alms',
    # verbose_name="alms", )
    ...
    # through='AssocFactoidPoss_revenuesilver', verbose_name="revenue in
    # silver", )
    ...
    #         max_length=765, null=True, blank=True, verbose_name="short
    # description", )
    #     # new dates 15/1/10
    #     has_firmdate = models.BooleanField(
    ...
    #     from_modifier = models.CharField(
    #         blank=True, max_length=3, choices=DATE_MODIFIERS,
    #         verbose_name="date of factoid  - FROM", help_text="modifier")
    #  exa
    #     from_weekday = models.IntegerField(
    #         blank=True, null=True, choices=WEEKDAY_CHOICES, verbose_name="",
    #         help_text="weekday")
    ...
    #     # end ======== new dates 15/1/10
    #     probabledate = models.CharField(
    #         max_length=765, null=True, blank=True, verbose_name="probable
    # date", )
    #     datingnotes = models.TextField(
    #         null=True, blank=True, verbose_name="dating notes", )
    #     notes = models.TextField(null=True, blank=True,
    ...
    #         default=True, verbose_name="Calculate floruits automatically (
    # warning: saving time can take longer)",
    #         help_text="DISABLED: please re-save persons individually in
    # order to update their floruits (or ask the db "
    #                   "administrator to do that for you as a batch
    # operation)")
    #     # help_text="DISABLED Using all primary transactions where person
    # has role: Grantor, Beneficiary, Addressor,
    #     # Addressee, Party 1, Party 2, Party 3, Consentor, Dated by hand
    # of, Inspector, Scribe, Sealer, Signatory, Witness")
    #     # 2010-09-01: the following field conflates all people
    # associations, for
    #     # faster searching...
    #     helper_people = models.ManyToManyField(
    #         Person, through='AssocHelperPerson',
    # related_name='helperfactoids',
    ...
    #
    #     def get_right_subclass(self):
    #         # once you get a factois instance, it's useful to know quickly
    #  what
    #         # subclass it is...
    #         try:
    ...
    #     titletypekey = models.ForeignKey('TitleType', verbose_name="title
    # type", )
    #     # these two are booleans, but's there are some strange '-1' in the
    #  db..
    #     # maybe it'll break
    ...
    #         default=False, blank=True, verbose_name="by another divine
    # invocation", )
    #
    #     def save(self, force_insert=False, force_update=False):
    ...
    #         )
    #         # 2012-06-19: can delete the one above, after updating the
    # roles stuff
    ...
    #     def get_admin_url(self):
    #         from django.core import urlresolvers
    #         return urlresolvers.reverse('admin:pomsapp_facttitle_change',
    # args=(self.id,))
    ...
    #         """fills out the firmdate field"""
    #         if EXTRA_SAVING_ACTIONS:
    #             super(FactRelationship, self).save(force_insert,
    # force_update)
    #             self.firmdate = create_firmdate(self)
    #             self = create_helperKeywordsearch(self)
    #             self = fix_inferredType(self)
    ...
    #         # raw_id_fields = ('sourcekey', )
    #         related_search_fields = {
    #             'sourcekey': ('hammondnumber', 'hammondnumb2',
    # 'hammondnumb3'), 'placefielty': ('name',), }
    #
    #         def save_model(self, request, obj, form, change):
    #             """adds the user information when the rec is saved"""
    #             if getattr(obj, 'created_by', None) is None:
    ...
    #
    #     def __str__(self):
    #         return "id[%s], from source [%s], desc: %s" % (self.id,
    # self.sourcekey, self.shortdesc)
    #
    #     table_order = 12
    #
    #
    ...
    #             AssocFactoidPoss_unfreepInline,
    # AssocFactoidPoss_revsilverInline, AssocFactoidPoss_revkindInline,
    #             AssocFactoidPoss_pgeneralInline,
    # AssocFactoidPoss_officeInline, AssocFactoidPoss_objectsInline,
    ...
    #         Transactiontype, null=True, blank=True, verbose_name="type of
    # transaction", )
    #
    #     isprimary = models.BooleanField(default=False,
    # verbose_name="Primary")
    #     isdare = models.BooleanField(default=False, verbose_name="Dare?")
    #     isexchange = models.BooleanField(default=False,
    ...
    #         default=False,
    #         verbose_name="Witnesses in original, but not copied into
    # cartulary")
    ...
    #     warrandice = models.BooleanField(default=False,
    # verbose_name="warrandice")
    #
    ...
    #
    #     helper_tickboxes = models.ManyToManyField(
    #         'TransTickboxes', blank=True, verbose_name="normalization of
    # tickboxes",
    #         help_text="Helper field used for the faceted search - see
    # actionsmodels", )
    #
    ...
    #                         copy_dates_over(x, obj)
    #             obj.save()
    #             # previously: if obj.firmdate == "" and obj.datingnotes ==
    #  "" and
    ...
    #             req = request.POST
    #             # x = req.items()    # just printing all the items so that
    #  I can check them...
    #             # obj.notes = str(x)
    #             # temp = ""
    #             # assoc_fields contains the name of the forms where we're
    # looking
    #             assoc_fields = [
    ...
    #                 tot_forms = req.get(
    #                     assoc + "_set-TOTAL_FORMS", None)  # getting the
    # num of inlines
    #                 for i in range(0, int(tot_forms)):  # foreach check if
    #  there's a title
    #                     # title info
    ...
    #                     originallanguage = req.get(stringa_origlanguage,
    # None)
    ...
    #                         # i'm passing the whole obj so that the dates
    # can be
    #                         # copied over
    #                         print(
    ...
    #                             request.user, obj.sourcekey, titleid,
    # gracegod, divineinvocation, obj,
    #                             personid, originallanguage,
    # nametranslation, medievalform)
    #
    #         # method for creating a title-factoid on the fly
    #         def create_title_fact(self, userobj, sourceobj, titleid,
    # gracegod, divineinvocation, obj_for_dates,
    #                               personid, originallanguage,
    # nametranslation, medievalform):
    #
    ...
    # 'updated_at',)
    #         filter_horizontal = (
    #             'sicutclauses', 'renderdates', 'rendernominal',
    # 'tenendas', 'spiritualbenefits', 'exemptions',
    #             'legalpertinents', 'returnsmilitary', 'returnsrenders',
    # 'commonburdens')
    #         # radio_fields = {"ltbrole": admin.VERTICAL}
    #         inlines = (
    ...
    #              {'fields': ['tenendas', 'tenendasclauseolang',
    # 'exemptions', 'exemptionclauseolang', ],
    #               'classes': ['collapse']
    #               }),
    #             ('Clauses: renders',
    #              {'fields':
    ...
    #                'perambulation', 'ismalediction',
    # 'corroborationsealing', 'bothaddressorsmentioned',
    #                'warrandice'
    #                ],
    #               'classes': ['collapse']
    #               }),
    ...
    #         max_length=765, null=True, blank=True, verbose_name="generic
    # name", )
    #     articletext = models.CharField(
    #         max_length=765, null=True, blank=True, verbose_name="article
    # text", )
    #     specificname = models.CharField(
    #         max_length=765, null=True, blank=True, verbose_name="specific
    # name", )
    ...
    #         max_length=765, null=True, blank=True, verbose_name="root
    # ancestor - utility field", )
    #     helper_name = models.CharField(
    #         max_length=765, null=True, blank=True, verbose_name="helper
    # name used for diplay purposes", )
    #     helper_keywordsearch = models.TextField(
    #         verbose_name="Field for the keyword search", null=True,
    # blank=True, )
    ...
    #     def get_admin_url(self):
    #         from django.core import urlresolvers
    #         return urlresolvers.reverse('admin:pomsapp_place_change',
    # args=(self.id,))
    #
    #     get_admin_url.allow_tags = True
    #
    ...
    #                 force_insert, force_update)  # Call the "real" save()
    # method.
    ...
    #                 ret.append(x)
    #         for x in Factoid.objects.filter(
    # assocfactoidposs_office__poss_office__place__id=self.id):
    #             if x not in ret:
    #                 ret.append(x)
    #         for x in Factoid.objects.filter(
    ...
    #             actions.insert(0,
    #                            u'<a href="add/?parent=%s" title="%s"><img
    # src="%simg/admin/icon_addlink.gif" '
    #                            u'alt="%s"></a>' % (
    ...
    #
    #         list_display = (
    #             'name', 'id', 'parent', 'editedrecord', 'review',
    ...
    # #
    # =============================================================================
    # #  SIGNALS; removed on 2012-06-18 as the save() action addressed the
    # same issue
    # #
    # =============================================================================
    #
    ...
    # # def handler_for_transactionfactoids(sender, instance, created,
    # **kwargs):
    # # added 11-Nov-09 to manage the inferred_type field
    # #   if not instance.inferred_type and EXTRA_SAVING_ACTIONS:
    # #       try:
    ...
    # # person = build_floruits(x.person, x.has_firmdate,
    ...
    # # post_save.connect(handler_for_transactionfactoids,
    # sender=FactTransaction)
