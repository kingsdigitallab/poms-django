...
def render_template_block(template, block, context):
    """
    Renders a single block from a template. This
    template should have previously been rendered.
    """
...
def render_block_to_string(
        template_name, block, dictionary=None, context_instance=None):
    """
    Loads the given template_name and renders the
    given block with the given dictionary as
...
# def direct_block_to_template(request, template, block,
# extra_context=None, mimetype=None, **kwargs):
#     """
#     Render a given block in a given template with any extra
# URL parameters in the context as
#     ``{{ params }}``.
#     """
...
#     t.render(c)
# return HttpResponse(render_template_block(t, block, c),
# mimetype=mimetype)
